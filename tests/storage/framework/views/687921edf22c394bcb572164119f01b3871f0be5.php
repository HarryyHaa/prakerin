...
<body>
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/40.jpg')); ?>')">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    ...
                    <div class="about-us-content bg-white mb-30 p-30 box-shadow">
                        ...
                        <img class="mt-15" src="<?php echo e(asset('assets/frontend/img/bg-img/35.jpg')); ?>" alt="">
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="<?php echo e(asset('assets/frontend/img/bg-img/36.jpg')); ?>" alt="">
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="<?php echo e(asset('assets/frontend/img/bg-img/37.jpg')); ?>" alt="">
                                <div class="social-btn">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="<?php echo e(asset('assets/frontend/img/bg-img/38.jpg')); ?>" alt="">
                                <div class="social-btn">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="<?php echo e(asset('assets/frontend/img/bg-img/39.jpg')); ?>" alt="">
                                <div class="social-btn">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
...
</html><?php /**PATH C:\xampp\htdocs\prakerin\resources\views/about.blade.php ENDPATH**/ ?>