...
<body>
        ...
        <div class="mag-main-menu" id="sticker">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <!-- Nav brand -->
                    <a href="/" class="nav-brand"><img src="<?php echo e(asset('assets/frontend/img/core-img/logo.png')); ?>" alt=""></a>
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/41.jpg')); ?>)">
                ...
                <div class="col-12 col-xl-8">
                    <div class="archive-posts-area bg-white p-30 mb-30 box-shadow">
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/42.jpg')); ?>)">
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/43.jpg')); ?>)">
                                <a href="/video_post" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/44.jpg')); ?>)">
                                <a href="/video_post" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/45.jpg')); ?>)">
                                <a href="/video_post" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/46.jpg')); ?>)">
                                <a href="/video_post" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/47.jpg')); ?>)">
                                <a href="/video_post" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/48.jpg')); ?>)">
                                <a href="/video_post" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                    <div class="sidebar-area bg-white mb-30 box-shadow">
                        ...
                        <div class="single-sidebar-widget">
                            <a href="#" class="add-img"><img src="<?php echo e(asset('assets/frontend/img/bg-img/add2.png')); ?>" alt=""></a>
                        </div>
                        ...
                        <div class="single-sidebar-widget p-30">
                            ...
                            <div class="single-youtube-channel d-flex">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo e(asset('assets/frontend/img/bg-img/14.jpg')); ?>" alt="">
                                </div>
                            ...
                            <div class="single-youtube-channel d-flex">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo e(asset('assets/frontend/img/bg-img/15.jpg')); ?>" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo e(asset('assets/frontend/img/bg-img/16.jpg')); ?>" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo e(asset('assets/frontend/img/bg-img/17.jpg')); ?>" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo e(asset('assets/frontend/img/bg-img/18.jpg')); ?>" alt="">
                                </div>
                                <div class="youtube-channel-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <!-- Logo -->
                        <a href="/" class="foo-logo"><img src="<?php echo e(asset('assets/frontend/img/core-img/logo2.png')); ?>" alt=""></a>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="single-blog-post style-2 d-flex">
                            <div class="post-thumbnail">
                                <img src="<?php echo e(asset('assets/frontend/img/bg-img/12.jpg')); ?>" alt="">
                            </div>
                            <div class="post-content">
                        ...
                        <div class="single-blog-post style-2 d-flex">
                            <div class="post-thumbnail">
                                <img src="<?php echo e(asset('assets/frontend/img/bg-img/13.jpg')); ?>" alt="">
                            </div>
                            <div class="post-content">
...
</html><?php /**PATH C:\xampp\htdocs\prakerin\resources\views/archive.blade.php ENDPATH**/ ?>