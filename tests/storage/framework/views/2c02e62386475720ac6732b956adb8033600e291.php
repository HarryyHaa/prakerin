...
<body>
        ...
        <div class="mag-main-menu" id="sticker">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <!-- Nav brand -->
                    <a href="index.html" class="nav-brand"><img src="<?php echo e(asset('assets/frontend/img/core-img/logo.png')); ?>" alt=""></a>
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="background-image: url(<?php echo e(asset('assets/frontend/img/bg-img/49.jpg')); ?>)">
                ...
                <div class="col-12 col-xl-8">
                    <div class="post-details-content bg-white mb-30 p-30 box-shadow">
                        <div class="blog-thumb mb-30">
                            <img src="<?php echo e(asset('assets/frontend/img/bg-img/50.jpg')); ?>" alt="">
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4">
                                    <img class="mb-15" src="<?php echo e(asset('assets/frontend/img/bg-img/51.jpg')); ?>" alt="">
                                </div>
                            </div>
                            ...
                            <div class="post-author d-flex align-items-center">
                                <div class="post-author-thumb">
                                    <img src="<?php echo e(asset('assets/frontend/img/bg-img/52.jpg')); ?>" alt="">
                                </div>
                    ...
                    <div class="related-post-area bg-white mb-30 px-30 pt-30 box-shadow">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-blog-post style-4 mb-30">
                                    <div class="post-thumbnail">
                                        <img src="<?php echo e(asset('assets/frontend/img/bg-img/29.jpg')); ?>" alt="">
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-blog-post style-4 mb-30">
                                    <div class="post-thumbnail">
                                        <img src="<?php echo e(asset('assets/frontend/img/bg-img/30.jpg')); ?>" alt="">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-blog-post style-4 mb-30">
                                    <div class="post-thumbnail">
                                        <img src="<?php echo e(asset('assets/frontend/img/bg-img/28.jpg')); ?>" alt="">
                                    </div>
                                    <div class="post-content">
                        ...
                        <ol>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="<?php echo e(asset('assets/frontend/img/bg-img/53.jpg')); ?>" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            <!-- Comment Author -->
                                            <div class="comment-author">
                                                <img src="<?php echo e(asset('assets/frontend/img/bg-img/54.jpg')); ?>" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                            <div class="comment-meta">
                                                <a href="#" class="comment-date">27 Aug 2019</a>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    <!-- Comment Author -->
                                    <div class="comment-author">
                                        <img src="<?php echo e(asset('assets/frontend/img/bg-img/55.jpg')); ?>" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                    <div class="comment-meta">
                                        <a href="#" class="comment-date">27 Aug 2019</a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <!-- Logo -->
                        <a href="index.html" class="foo-logo"><img src="<?php echo e(asset('assets/frontend/img/core-img/logo2.png')); ?>" alt=""></a>
...
</html><?php /**PATH C:\xampp\htdocs\prakerin\resources\views/singel_post.blade.php ENDPATH**/ ?>