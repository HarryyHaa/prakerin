...
<body>
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="background-image: url({{ asset('assets/frontend/img/bg-img/r.jpg')}})">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    ...
                    <div class="about-us-content bg-white mb-30 p-30 box-shadow">
                        ...
                        <img class="mt-15" src="{{ asset('assets/frontend/img/bg-img/35.jpg')}}" alt="">
